...
Open [app.altheia.xyz](https://app.altheia.xyz) and connect Phantom. Your wallet becomes the operator authority. The first time you sign in, an `OperatorAccount` PDA is created on Solana.
